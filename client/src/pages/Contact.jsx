    ...
    return (
        <form className="flex flex-col items-center text-sm text-slate-800">
            ...
            <div className="max-w-96 w-full px-4">
                ...
                <textarea rows="4" className="w-full mt-2 p-2 bg-transparent border border-slate-300 bg-secondary/10  rounded-lg resize-none outline-none focus:ring-2 focus-within:ring-indigo-400 transition-all" placeholder="Enter your message" required></textarea>
