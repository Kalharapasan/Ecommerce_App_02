...
const AddProduct = () => {
  ...
  return (
    <div className='md:px-8 py-6 xl:py-8 m-1.5 sm:m-3 h-[97vh] overflow-y-scroll lg:w-11/12 bg-primary shadow rounded-xl'>
      <form onSubmit={onSubmitHandler} className='flex flex-col gap-y-5 px-2 text-sm w-full lg:w-11/12'>
        ...
        <div className='w-full border-t pt-5'>
          ...
          <div className='flex gap-3 mb-4'>
            ...
            />
            <button type='button' onClick={addSizePrice} className='btn-secondary font-semibold px-5 py-2.5 rounded-lg whitespace-nowrap'>
              Add
            </button>
          </div>
                ...
                >
                  ...
                  <div className='h-24 bg-white flexCenter'>
                    <img
                      ...
                      alt=''
                      className='w-12 overflow-hidden object-contain'
                    />
                  </div>
                </label>
              ))}
        ...
        <div className='flex items-center gap-3 mt-5 border-t pt-5'>
          ...
          />
          <label htmlFor='popular' className='h5 cursor-pointer'>
            Add to Popular
          </label>
        </div>
